...
(async()=>{
    ...
    const modrinth_response = await fetch("https://api.modrinth.com/v2/user/QCe37V9V/projects");
    let total_stars = 0;
    let fork_amount = 0;
    ...
    const rendered = nj.render("README_TEMPLATE.njk", {stars: total_stars, projects: github_json_data.length, forks: fork_amount, mod_downloads: total_downlaods});
